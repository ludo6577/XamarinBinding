...
SWIFT_MODULE_NAMESPACE_PUSH("TrackerExtension")
@class Tracker;

/// Use this class to manage tracker instances
SWIFT_CLASS("_TtC16TrackerExtension10ATInternet")
...
SWIFT_CLASS("_TtC16TrackerExtension14ATReachability")
...
SWIFT_CLASS("_TtC16TrackerExtension14BusinessObject")
...
SWIFT_CLASS("_TtC16TrackerExtension14AbstractScreen")
...
SWIFT_CLASS("_TtC16TrackerExtension10ScreenInfo")
...
SWIFT_CLASS("_TtC16TrackerExtension5Aisle")
...
- (nonnull instancetype)initWithTracker:(Tracker * _Nonnull)tracker OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC16TrackerExtension9RichMedia")
...
SWIFT_CLASS("_TtC16TrackerExtension5Audio")
...
SWIFT_CLASS("_TtC16TrackerExtension6Audios")
@interface Audios : NSObject
@property (nonatomic, copy) NSDictionary<NSString *, Audio *> * _Nonnull list;
/// MediaPlayer instance
@property (nonatomic, strong) MediaPlayer * _Nonnull player;
/// Audios initializer
...
/// returns:
/// Audios instance
- (nonnull instancetype)initWithPlayer:(MediaPlayer * _Nonnull)player OBJC_DESIGNATED_INITIALIZER;
/// Add a new Audio
...
/// Background task
SWIFT_CLASS("_TtC16TrackerExtension14BackgroundTask")
...
SWIFT_CLASS("_TtC16TrackerExtension6Buffer")
...
/// Hit builder
SWIFT_CLASS("_TtC16TrackerExtension7Builder")
@interface Builder : NSOperation
/// Sends hit
- (void)main;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC16TrackerExtension8Campaign")
...
SWIFT_CLASS("_TtC16TrackerExtension9Campaigns")
...
SWIFT_CLASS("_TtC16TrackerExtension4Cart")
...
SWIFT_CLASS("_TtC16TrackerExtension13Configuration")
...
SWIFT_CLASS("_TtC16TrackerExtension7Context")
...
SWIFT_CLASS("_TtC16TrackerExtension12CustomObject")
...
SWIFT_CLASS("_TtC16TrackerExtension13CustomObjects")
...
SWIFT_CLASS("_TtC16TrackerExtension19CustomTreeStructure")
...
SWIFT_CLASS("_TtC16TrackerExtension20CustomTreeStructures")
...
SWIFT_CLASS("_TtC16TrackerExtension9CustomVar")
...
SWIFT_CLASS("_TtC16TrackerExtension10CustomVars")
...
SWIFT_PROTOCOL("_TtP16TrackerExtension15TrackerDelegate_")
...
SWIFT_CLASS("_TtC16TrackerExtension22DefaultTrackerDelegate")
...
SWIFT_CLASS("_TtC16TrackerExtension10Dispatcher")
...
SWIFT_CLASS("_TtC16TrackerExtension13DynamicScreen")
...
SWIFT_CLASS("_TtC16TrackerExtension14DynamicScreens")
...
SWIFT_CLASS("_TtC16TrackerExtension5Event")
...
SWIFT_CLASS("_TtC16TrackerExtension7Gesture")
...
@property (nonatomic) enum GestureEventType type;
/// Screen information on which the gesture has been done
@property (nonatomic, weak) Screen * _Nullable screen;
...
SWIFT_CLASS("_TtC16TrackerExtension8Gestures")
...
SWIFT_CLASS("_TtC16TrackerExtension3Hit")
...
/// returns:
/// type of hit
- (enum HitType)getHitType SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC16TrackerExtension17IdentifiedVisitor")
...
SWIFT_CLASS("_TtC16TrackerExtension14InternalSearch")
...
SWIFT_CLASS("_TtC16TrackerExtension16InternalSearches")
...
/// Life cycle metrics
SWIFT_CLASS("_TtC16TrackerExtension9LifeCycle")
...
SWIFT_CLASS("_TtC16TrackerExtension9LiveAudio")
...
SWIFT_CLASS("_TtC16TrackerExtension10LiveAudios")
@interface LiveAudios : NSObject
@property (nonatomic, copy) NSDictionary<NSString *, LiveAudio *> * _Nonnull list;
/// MediaPlayer instance
@property (nonatomic, strong) MediaPlayer * _Nonnull player;
...
SWIFT_CLASS("_TtC16TrackerExtension9LiveVideo")
@interface LiveVideo : RichMedia
@end


/// Wrapper class to manage Live Audio instances
SWIFT_CLASS("_TtC16TrackerExtension10LiveVideos")
...
SWIFT_CLASS("_TtC16TrackerExtension8Location")
...
SWIFT_CLASS("_TtC16TrackerExtension9Locations")
@interface Locations : NSObject
/// Tracker instance
@property (nonatomic, strong) Tracker * _Nonnull tracker;
...
SWIFT_CLASS("_TtC16TrackerExtension11MediaPlayer")
...
SWIFT_CLASS("_TtC16TrackerExtension12MediaPlayers")
...
SWIFT_CLASS("_TtC16TrackerExtension6NuggAd")
...
SWIFT_CLASS("_TtC16TrackerExtension7NuggAds")
...
SWIFT_CLASS("_TtC16TrackerExtension7Offline")
...
SWIFT_CLASS("_TtC16TrackerExtension7OnAppAd")
...
SWIFT_CLASS("_TtC16TrackerExtension5Order")
...
SWIFT_CLASS("_TtC16TrackerExtension11OrderAmount")
...
SWIFT_CLASS("_TtC16TrackerExtension14OrderCustomVar")
...
SWIFT_CLASS("_TtC16TrackerExtension15OrderCustomVars")
...
SWIFT_CLASS("_TtC16TrackerExtension13OrderDelivery")
...
SWIFT_CLASS("_TtC16TrackerExtension13OrderDiscount")
...
SWIFT_CLASS("_TtC16TrackerExtension6Orders")
...
/// Hit parameter
SWIFT_CLASS("_TtC16TrackerExtension5Param")
@interface Param : NSObject
/// Default initializer
///
/// returns:
/// a parameter with no key and no value
- (nonnull instancetype)init;
@end


/// Parameter option
SWIFT_CLASS("_TtC16TrackerExtension11ParamOption")
...
/// Plugin management
SWIFT_CLASS("_TtC16TrackerExtension6Plugin")
...
/// Plugin parameter
SWIFT_CLASS("_TtC16TrackerExtension11PluginParam")
@interface PluginParam : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Known hit type
SWIFT_CLASS("_TtC16TrackerExtension16ProcessedHitType")
@interface ProcessedHitType : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC16TrackerExtension7Product")
...
SWIFT_CLASS("_TtC16TrackerExtension8Products")
...
SWIFT_CLASS("_TtC16TrackerExtension9Publisher")
...
SWIFT_CLASS("_TtC16TrackerExtension19PublisherImpression")
...
SWIFT_CLASS("_TtC16TrackerExtension20PublisherImpressions")
...
SWIFT_CLASS("_TtC16TrackerExtension10Publishers")
...
/// Read only parameter
SWIFT_CLASS("_TtC16TrackerExtension13ReadOnlyParam")
@interface ReadOnlyParam : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC16TrackerExtension6Screen")
...
/// Wrapper class to manage Screen instances
SWIFT_CLASS("_TtC16TrackerExtension7Screens")
@interface Screens : NSObject
- (Screen * _Nonnull)addWithScreen:(Screen * _Nonnull)screen SWIFT_WARN_UNUSED_RESULT;
/// Add a new screen
///
/// returns:
/// the Screen instance
...
SWIFT_CLASS("_TtC16TrackerExtension13SelfPromotion")
...
SWIFT_CLASS("_TtC16TrackerExtension23SelfPromotionImpression")
...
SWIFT_CLASS("_TtC16TrackerExtension24SelfPromotionImpressions")
...
SWIFT_CLASS("_TtC16TrackerExtension14SelfPromotions")
...
/// Hit sender
SWIFT_CLASS("_TtC16TrackerExtension6Sender")
@interface Sender : NSOperation
...
SWIFT_CLASS("_TtC16TrackerExtension15SliceReadyParam")
@interface SliceReadyParam : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Stored Offline hit
SWIFT_CLASS("_TtC16TrackerExtension16StoredOfflineHit")
@interface StoredOfflineHit : NSManagedObject
/// Hit
@property (nonatomic, copy) NSString * _Nonnull hit;
/// Date of creation
@property (nonatomic, copy) NSDate * _Nonnull date;
/// Number of retry that were made to send the hit
@property (nonatomic, strong) NSNumber * _Nonnull retry;
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


/// Contextual information from user device
SWIFT_CLASS("_TtC16TrackerExtension16TechnicalContext")
@interface TechnicalContext : NSObject
...
SWIFT_CLASS("_TtC16TrackerExtension4Tool")
...
SWIFT_CLASS("_TtC16TrackerExtension7Tracker")
@interface Tracker : NSObject
@property (nonatomic, weak) id <TrackerDelegate> _Nullable _delegate;
...
/// Contains parameters
@property (nonatomic, strong) Buffer * _Nonnull buffer;
/// Dispatcher
@property (nonatomic, strong) Dispatcher * _Nonnull dispatcher;
@property (nonatomic, copy) NSDictionary<NSString *, BusinessObject *> * _Nonnull businessObjects;
...
@property (nonatomic, readonly, strong) Event * _Nonnull event;
...
/// \param options parameter options
///
- (void)handleNotStringParameterSetting:(NSString * _Nonnull)key value:(id _Nonnull)value options:(ParamOption * _Nullable)options;
...
SWIFT_CLASS("_TtC16TrackerExtension24TrackerConfigurationKeys")
...
/// Operation queue
SWIFT_CLASS("_TtC16TrackerExtension12TrackerQueue")
@interface TrackerQueue : NSObject
/// Private initializer (cannot instantiate BuilderQueue)
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
/// TrackerQueue singleton
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) TrackerQueue * _Nonnull sharedInstance;)
+ (TrackerQueue * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
/// Queue
...
SWIFT_CLASS("_TtC16TrackerExtension5Video")
...
SWIFT_CLASS("_TtC16TrackerExtension6Videos")
@interface Videos : NSObject
@property (nonatomic, copy) NSDictionary<NSString *, Video *> * _Nonnull list;
/// MediaPlayer instance
@property (nonatomic, strong) MediaPlayer * _Nonnull player;
/// Videos initializer
/// \param player the player instance
